...
async function main() {
  for (const line of deletedTrucks) {
    ...
    // I will try to recreate them with model 'S450 Rekrutowa' or just 'S450' as a default
    // Wait, some had S450 Rekrutowa, some had W1 DUSK. I will use 'S450 Rekrutowa' for the ones with GDA/GA/WGM
    let model = 'S450 Rekrutowa';
    if (plate.startsWith('W')) model = 'S650 V8 High Line'; // Just a generic fallback
